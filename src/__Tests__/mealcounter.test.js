...
describe('getMealData function', () => {
  ...
  test('should return an array with 3 meal objects', () => getMealData().then((data) => {
  ...
  test('should have a strMeal, strMealThumb, and idMeal properties for each meal', () => getMealData().then((data) => {
